"""
瑞士楚格 LCDH — siglomundo.ch (Shopify, CHF)
Collection: cuban-cigars
Variant titles in German: Einzeln / Xer Kiste / Schachtel
"""
...
@register
class SiglomundoScraper(BaseScraper):
    source_slug = "siglomundo"
